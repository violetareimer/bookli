...
function makeMookNunjucks() {
    return {
        render(template, context) { return template; }
    }
}
...
describe('Utils', () => {
    ...
    test('assign', () => {
        ...
        expect(result).toStrictEqual({ id: 1, title: 'El aleph', author: 'Borges' });
    ...
    test('render with refs', () => {
        window.nunjucks = makeMookNunjucks();
        const refs = utils.render('<div data-ref="myDiv"></div>', {}, document.body);
